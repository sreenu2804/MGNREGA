...
import os
from flask import *
src="C:/Users/sreenivas/PycharmProjects/major_project/images/"
path = 'images'
...
def atten(da,aadhar):
    ...
    mycursor = mydb.cursor()
    aadhar = aadhar
    srcimg="C:/Users/sreenivas/PycharmProjects/major_project/Input_image/face.jpg"
...
def insertion():
    ...
    if len(classNames) != 0:
        for w in range(0, len(names)):
            src = "C:/Users/sreenivas/PycharmProjects/major_project/images/" + classNames[w] + ".jpg"
            dst = "C:/Users/sreenivas/PycharmProjects/major_project/Processed_images/" + classNames[w] + ".jpg"
            shutil.move(src, dst)
    print("Data was inserted successfully")
    return "success"
def renameimg1():
    fn = "C:/Users/sreenivas/PycharmProjects/major_project/Input_image/face.jpg"
    # src="C:/Users/sreenivas/Downloads/input_data_img(1).jpg"
    src="C:/Users/sreenivas/Downloads/face.jpg"
    os.rename(src, fn)
    return "success"
def renameimg(name,aadhar,age,gender):
    fn = "C:/Users/sreenivas/PycharmProjects/major_project/Images/"+ name + " " + aadhar + " " + age + " " + gender + ".jpg"
    # src="C:/Users/sreenivas/Downloads/input_data_img(1).jpg"
    src="C:/Users/sreenivas/Downloads/input_data_img.jpg"
    os.rename(src, fn)
    return "success"
def deletion(val):
    mycursor = mydb.cursor()
    ...
    age = myresult[0][1]
    gen = myresult[0][2]
    src = "C:/Users/sreenivas/PycharmProjects/major_project/Processed_images/" + na + " " + d + " " + age + " " + gen + ".jpg"
    dst = "C:/Users/sreenivas/PycharmProjects/major_project/Deleted_images/" + na + " " + d + " " + age + " " + gen + ".jpg"
    shutil.move(src, dst)
...
def test1():
    ...
    if request.method == "POST" or "GET":
        ...
        if li[2] == b'pro=submit' and li[0]!=b'aadhar=' and li[1]!=b'date=':
            ...
            print(aadhar)
            re=atten(da,aadhar)
            os.remove("C:/Users/sreenivas/PycharmProjects/major_project/Input_image/face.jpg")
            if re=="success":
            ...
            print("delete")
            os.remove("C:/Users/sreenivas/Downloads/face.jpg")
            print("delete")
            return render_template('test1.html')
    return render_template('try_again.html')
...
def test2():
    ...
    if request.method == "POST" or "GET":
        ...
        if aadhar!="" and pro=="submit":
            ...
            print("delete")
            os.remove("C:/Users/sreenivas/Downloads/input_data_img.jpg")
            print("delete")
            return render_template('test2.html')
    return render_template('try_again.html')
